...
const CARD_STYLES = {
  ...
  hover:
    'hover:bg-white/60 dark:hover:bg-black/60 hover:-translate-y-1 hover:shadow-[0_16px_45px_rgb(0,0,0,0.1)] dark:hover:shadow-[0_16px_45px_rgb(255,255,255,0.1)]',
};
      ...
      >
        {developer.name === 'Dci' && (
          <>
            {/* RGB光效 */}
            <div
              className="absolute -inset-[1px] rounded-xl bg-gradient-to-r from-[#a8edea]/0 via-[#a8edea]/20 to-[#fed6e3]/20 
        ...
        <div className="relative flex flex-col h-full">
          ...
          <div className="flex items-start gap-5">
            {/* 头像 */}
            <div
              className="relative shrink-0 w-16 h-16 rounded-lg overflow-hidden bg-black/5 dark:bg-white/5
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base text-black/40 dark:text-white/40 shrink-0">{developer.role}</span>
              </div>
          ...
          <div className="flex flex-wrap gap-2 mt-auto">
            ...
            {developer.tags.length > 3 && (
              <span className="text-base text-black/40 dark:text-white/40">+{developer.tags.length - 3}</span>
            )}
          </div>
        </div>
      </div>
