...
import { ChevronDown, ChevronUp, List, Pause, Play, SkipBack, SkipForward, Volume2, VolumeX } from 'lucide-react';
import Image from 'next/image';
import { useEffect, useRef, useState } from 'react';
import { useMusicPlayer } from '@/hooks/useMusicPlayer';
import { usePlayerStore } from '@/hooks/usePlayerStore';
import { HapticFeedback, triggerHaptic } from '@/utils/haptics';
import { getPlaylist, getPlayProgress, getSavedPlaylist, savePlayProgress, type Track } from '@/utils/netease';
        ...
        {isMobile ? (
          ...
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 right-0">
              <ProgressBar progress={progressPercent} isPlaying={isPlaying} onClick={handleProgressClick} />
            </div>
            ...
            <div className="h-20 flex items-center px-4 pt-2">
              <div className="flex items-center flex-1 gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-medium text-black/80 dark:text-white/80 truncate">{currentTrack.name}</h3>
                  <p className="text-xs text-black/60 dark:text-white/60 truncate">{currentTrack.artist}</p>
          ...
          <div className="p-4 space-y-4">
            ...
            >
              <div
                className={clsx('absolute inset-0 bg-black/5 dark:bg-white/5', isImageLoading ? 'block' : 'hidden')}
              />
              <Image
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-sm text-black/60 dark:text-white/60 line-clamp-1">{currentTrack.artist}</p>
            </div>
