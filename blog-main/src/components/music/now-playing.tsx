...
import { createVolumeHaptic, HapticFeedback, triggerHaptic } from '@/utils/haptics';
                ...
                <div className="col-span-3">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-foreground font-semibold text-base truncate">{currentSong.title}</h3>
                      <p className="text-muted-foreground text-sm truncate">{currentSong.artist}</p>
                      <p className="text-muted-foreground/80 text-xs truncate mt-1">{currentSong.album}</p>
                    </div>
                  </div>
                          ...
                          {parsedLyrics.map((lyric, index) => {
                            ...
                            return (
                              <div
                                ...
                                style={{ opacity }}
                              >
                                <div className="max-w-full break-words text-center">{lyric.text || '♪'}</div>
                              </div>
                            );
                          })}
                        </motion.div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex-1 h-1.5 bg-muted rounded-full cursor-pointer" onClick={handleProgressClick}>
                        <motion.div
                        ...
                        return (
                          ...
                          >
                            <div className="relative w-10 h-10 rounded-lg overflow-hidden shadow-sm">
                              <Image src={song.coverUrl} alt={song.album} fill className="object-cover" sizes="40px" />
                            </div>
                            <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col justify-start sm:justify-center px-6 pt-0 pb-8 sm:p-0 space-y-5 sm:space-y-6">
                      ...
                      <div className="flex flex-col items-center gap-3 sm:gap-4">
                        ...
                        <div className="text-center w-full px-2">
                          ...
                          <p className="text-muted-foreground/80 text-sm sm:text-sm">{currentSong.album}</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 px-2">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-sm sm:text-xs text-muted-foreground w-12">{formatTime(duration)}</span>
                        </div>
                      </div>
                      ...
                      {nextUpSongs.length > 0 && (
                        <div className="border-t border-border pt-6 sm:pt-4 mt-2">
                          <h4 className="text-foreground font-semibold text-base sm:text-sm mb-4 sm:mb-3 px-2">
                            即将播放
                          </h4>
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-muted-foreground text-sm sm:text-xs truncate">{song.artist}</p>
                                  </div>
