import { Lyric, MusicUrl, SongDetail, UnifiedSong } from './types';
...
export async function getPlaylistSongs(limit = 20, offset = 0): Promise<UnifiedSong[]> {
...
export async function getMusicUrl(id: number, level = 'exhigh'): Promise<MusicUrl | null> {
