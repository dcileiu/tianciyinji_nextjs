      ...
      <div className="text-center space-y-8 md:space-y-12">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="space-y-2 md:space-y-3 -mt-16 sm:-mt-20 md:-mt-24">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium text-black dark:text-white">页面不存在</h2>
        ...
        <div className="pt-8 md:pt-12 space-y-4">
          <p className="text-sm text-black/40 dark:text-white/40">你可能在寻找：</p>
