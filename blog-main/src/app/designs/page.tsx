...
export default function DesignsPage() {
  ...
  return (
    ...
    >
      ...
      >
        <a href="/" onClick={exit} className="text-white/40 hover:text-white transition-colors duration-300">
              ...
              >
                {searchQuery.length > 0 &&
                  (() => {
                    ...
                    if (results.length === 0) {
                      return <div className="text-center text-white/30 text-lg py-20">没有找到相关设计</div>;
                    }
                ...
                {searchQuery.length === 0 && (
                  <div className="text-center text-white/20 text-sm py-20">输入关键词搜索设计</div>
                )}
              </div>
            </div>
