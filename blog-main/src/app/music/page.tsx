...
export default function MusicPage() {
  ...
  return (
    <div className="space-y-16 pt-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold tracking-tight text-foreground">音乐</h1>
        <p className="text-muted-foreground">听歌吗？ 每日更新。</p>
      </div>
      ...
      <div className="grid grid-cols-1 items-end gap-8 lg:grid-cols-3">
        ...
        <div className="relative flex h-full flex-col justify-between overflow-hidden lg:col-span-1">
          <div className="space-y-3">
            ...
            <p className="text-md text-muted-foreground">来自专辑《{currentSong.album}》</p>
          </div>
        ...
        <div className="hidden lg:col-span-1 lg:block">
          <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">接下来播放</h3>
          <div className="space-y-4">
      ...
      <div className="pt-16">
        <div className="mb-8 space-y-2">
          <h2 className="text-2xl font-bold tracking-tight text-foreground">唱片墙</h2>
          ...
          {!hasMore && playlist.length > 0 && (
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/50 rounded-full backdrop-blur-sm">
                ...
                <span className="text-muted-foreground text-sm font-medium">已加载全部歌曲 ({playlist.length} 首)</span>
                <div className="w-2 h-2 bg-muted-foreground rounded-full" />
              </div>
            </motion.div>
          )}
