...
const games: Game[] = [
  {
    ...
    description:
      '这座城市里面发生的事情，V，强尼银手，再到后来的百灵鸟，李德...每个人，每段故事都让我欲罢不能。说实话刚发售的时候非常的差，但直到往日之影DLC，它已经是传奇了。我非常推荐你玩玩它（包括DLC）',
  ...
  },
  {
    ...
    quote: '对我来说绝对是神作之一。',
    description:
      '一作和二作我都玩了。对于我来说，哪个都缺一不可。它足够身临其境，画面优美，足够扣人心弦。一开始或许会有些无聊。到后面你就离不开它了。',
  ...
  },
  {
    ...
    description:
      '长TTK的FPS游戏，国内叫终极角逐。Steam现在已经锁国区了（不过可以用xbox）。画面很好看，但可能不太适合新手，尤其是匹配机制，容易被大佬往死里干。不过如果你有足够的时间和耐心，而且很喜欢这种画风或者玩法，那我推荐你来试试。',
  ...
  },
  {
    ...
    quote: '和朋友玩再好不过了。',
    description:
      '相信你知道"兄弟兄弟"这个梗，原型就是这里面一个帕鲁。这个游戏我买了很久了，居然还在更新。虽然到处都有点简陋的感觉，但不妨碍它对得起这个价格，而且足够好玩。主要是捉帕鲁，建房子，打boss。Xbox可以咸鱼特价区几十块钱一份。',
  ...
  },
  {
    ...
    quote: '每一个选择都会改变结局。',
    description:
      '一款互动电影式的剧情游戏，讲述仿生人觉醒的故事。三条主线交织，你的每个决定都会影响剧情走向和角色命运。画面精美，剧情扣人心弦，多周目体验完全不同的结局。Steam特价才13.60，绝对值得一玩。',
      ...
      >
        ...
        <div className={`relative w-full h-full ${game.videoHeight ? 'video-container' : ''}`}>
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, #0B0B0B 0%, rgba(11,11,11,0.7) 25%, rgba(11,11,11,0.3) 50%, transparent 70%)',
            }}
          />
          ...
          <div className="absolute bottom-4 left-4 md:bottom-12 md:left-12 pr-24 md:pr-0">
            <h2 className="text-2xl md:text-5xl font-medium text-white">{game.title}</h2>
          </div>
        </div>
      </div>
