...
const projects: Project[] = [
  {
    ...
    longDescription:
      "一套完整的虚拟信用卡管理系统，包括客户端、运营端、风控端，支持卡片申请、额度管理、交易记录、风控监控等功能，提供安全可靠的虚拟支付解决方案。",
    image: "/35.jpg",
    technologies: [
      "Vue3",
      "Vite",
    ...
    githubUrl: "https://github.com/dcileiu",
    liveUrl: "/",
    date: "2024-04",
    category: "前端架构",
  },
  {
    ...
    longDescription:
      "这是一个基于Vue的API文档多人协同编辑系统，支持多人同时编辑、版本控制、权限管理等功能，提供完善的文档编写和发布机制。",
    image: "/32.jpg",
    technologies: [
      "Vue3",
      "Vite",
  ...
  },
  {
    ...
    longDescription:
      "这是一个现代化的全栈博客系统，采用Next.js作为前端框架，Node.js作为后端，支持文章管理、分类标签、主题切换等功能。界面设计简洁优雅，用户体验流畅。",
    image: "/31.jpg",
    technologies: [
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    longDescription:
      "为企业打造的数据可视化大屏系统，支持实时数据展示、多种图表类型、响应式布局，可以灵活配置数据源和图表样式。",
    image: "/37.jpg",
  ...
  },
  {
    ...
    longDescription:
      "这是一个基于Next.js的电商达人CRM系统，支持客户管理、订单管理、库存管理等功能，提供完善的客户关系管理机制。",
    image: "/36.jpg",
    technologies: [
      "Next.js",
      "Shadcn-ui",
  ...
  },
  {
    ...
    longDescription:
      "一款功能完整的移动端电商应用，支持商品浏览、购物车、订单管理、支付等核心功能，采用uni-app开发，同时支持iOS和Android平台。",
    image: "/34.jpg",
  ...
  return (
    ...
    >
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* 面包屑导航 */}
        <Breadcrumb items={[{ label: "个人作品集" }]} className="mb-6" />
        {/* Header */}
