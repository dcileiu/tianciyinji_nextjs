 ...
 * @Date: 2025-07-24 22:43:38
 * @LastEditors: tianci tianci1208@outlook.com
 * @LastEditTime: 2025-07-24 23:19:13
 * @FilePath: \my-website\src\app\components\public\Logo.tsx
 * @Description: Logo组件
 */
...
export default function Logo({ className, style, width, height }: LogoProps) {
  return (
    <svg 
      ...
      height={height}
    >
      <g fill="#759e46" transform="matrix(.34923 0 0 .34923 -2.282 -2.195)">
        <defs>
